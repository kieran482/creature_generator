...
<p>Step right up, step right up! See your creature self in 3 easy steps!</p>
...
<fieldset>
	...
	<p>
		<input type="radio" name="creature_type" value="an alien" id="alien">
		<label for="alien">Alien</label>
	</p>
	<p>
		<input type="radio" name="creature_type" value="a robot" id="robot">
